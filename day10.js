 ...
 const joltCounter = () => {
  fileParser('day10').then(data => {
    ...
    for (let i = 1; i < jolts.length; i++) {
      ...
      if (diff === 1) differenceOfOne++
      if (diff === 3) differenceOfThree++
    }
    console.log((`the product is ${differenceOfThree * differenceOfOne}`))
  })
 }
