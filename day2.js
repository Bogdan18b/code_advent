...
How many passwords are valid according to their policies? correct answer is 477
...
How many passwords are valid according to the new interpretation of the policies? correct answer is 686
*/
...
function reducer2(initial, current) {
  let [first, second, letter, word] = current
    if ((word[first - 1] === letter && word[second - 1] !== letter) ||
        (word[first - 1] !== letter && word[second - 1] === letter)
    ) {
      initial++
    }
    return initial
